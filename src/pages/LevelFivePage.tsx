...
export default function LevelFivePage({ onBack, onLevelComplete, onNextLevel }: LevelFivePageProps) {
            ...
            <div className="practice-shell">
              ...
              {levelComplete ? (
                <section className="level-complete">
                  ...
                  <LevelCompletionActions onBack={onBack} onNextLevel={onNextLevel} nextLevelNumber={6} />
                </section>
              ) : null}

...
### 0:00-1:15 开场：为什么四六级仍然要学语法

画面建议：展示网站首页和欢迎弹窗。

很多同学问我：四六级想考高分，或者考了几次一直没过，这两种情况到底需不需要学语法？

先给答案：肯定要学。

当然，我知道现在很多博主，或者你们平时接收到的信息，都在贬低语法的重要性。最常见的说法就是：你看老外也不懂什么语法规则，但人家照样能看懂句子、说出英语。

这个例子听起来有道理，但它忽略了一个关键前提：英语是他们的母语，不是我们的母语。

比如过去式。一个英语母语者从小每天都在听：yesterday I went，last week I saw，when I was young。对他来说，「过去发生的事」和动词形式的变化，是在真实生活里反复绑定到一起的。他不是先背规则再理解过去式，而是像我们听到「昨天我去了」一样，根本不用分析，也知道这件事发生在过去。

但我们没有这个英语环境。我们今天看到 see，明天看到 saw，后天又看到 have seen，如果没人告诉你这些形式分别在表达什么时间、什么状态、什么句子关系，你只能靠感觉硬猜。所以语法对我们来说，不是束缚，而是把别人十几年语言环境自然长出来的东西，用更短时间搭成一个清晰框架。

所以语法学习是必要的。但是针对四六级来说，我们学语法的目的只有一个：看懂句子。不要求你变成会做语法题的人，也不要求你把每条规则背得滚瓜烂熟。四六级里真正卡人的语法点，本质上就是分辨词性、抓句子主干、看懂从句和修饰关系。

这就是为什么我基于这个第一性原理，做了一个「小德英语 lab 四六级语法网站」：不带大家绕语法概念，而是帮你把四六级里最容易卡住的语法难点一关一关扫通。
